        ...
        <Flex.Item direction="row">
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              ...
              content={
                "В вашем Додзё есть личные устройства для телепортации на обьект вашей миссии. \
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              title={"Ваш наушник"}
              content={
                "В отличии от стандартных наушников большинства корпораций, наш вариант создан специально для помощи в вашем внедрении. \
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              ...
              content={
                "Порой клану нужны сведения которыми могут обладать люди работающие на обьекте вашей миссии. \
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              title={"Саботаж ИИ"}
              content={
                "Иногда у нас заказывают сабо- таж Искусственного интеллекта на обьектах операции. Это про- цесс сложный и требующий от нас основательной подготовки. \
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              ...
              content={
                'Иногда оценивая ваши шансы на выполнение миссии для их увеличения на обьектах, \
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              ...
              content={
                "На научных обьектах всегда есть своя команда учёных и мно- жество данных которые прихо- дится где то хранить. \
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              title={"Защита цели"}
              content={
                'Иногда богатые шишки платят за услуги защиты определённого человека. Если вам досталась такая цель помните следующее:\
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              title={"Кража денег"}
              content={
                "Как бы это не было тривиально. Иногда клан нуждается в день- гах. Или даже возможно вы задолжали нам. \
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              ...
              content={
                "В некоторых ситуациях чужой позор для клиентов гораздо интереснее чем смерть. \
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              title={"Подрыв отдела"}
              content={
                "Старые добрые бомбы. Эффек- тивные орудия уничтожения всего живого и неживого в большом радиусе. \
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              title={"Анализ крови"}
              content={
                '"Знай своего врага" - простая истина.\
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              title={"Генокрады"}
              content={
                "Черви возомнившие себя выше других видов потому, что умеют красть гены и имитировать их. \
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              title={"Вампиры"}
              content={
                "Дешёвые романы, истории и сказки прошлого описывали вампиров как хищников пьющих кровь людей в ночи и обладаю- щих магическими способно- стями. \
          ...
          <Button className="Button_green" height="32px" width="32px">
            ...
            <Tooltip
              title={"Синдикат"}
              content={
                "Наши хорошие знакомые. Сборище могущественных фигур в подпольном мире с закрытой системой руководства о которой известно мало... \
      ...
      <Flex direction="row" alignContent="center" ml={1.5}>
          ...
          >
            ...
            >
              ...
              <Tooltip
                title={"НЕВИДИМОСТЬ"}
                content={
                  "Вы формируете вокруг себя маскировочное поле скрыва- ющее вас из виду и приглуша- ющее ваши шаги.\
            ...
            >
              ...
              <Tooltip
                ...
                content={
                  "Создаёт двух клонов готовых помочь в битве и дезориенти- ровать противника\
            ...
            >
              ...
              <Tooltip
                title={"ФОРМА ДУХА"}
                content={
                  "Вы воздействуете на стабильность собственного тела посредством этой эксперементальной технологии.\
          ...
          <NoticeBox success={0} danger={0} align="center">
            ...
            >
              ...
              <Tooltip
                ...
                content={
                  "Вводит в вас эксперементальную лечебную смесь. Способную залечить даже сломанные кости и оторванные конечности.\
            ...
            >
              ...
              <Tooltip
                ...
                content={
                  "При использовании мгновенно телепортирует пользователя в случайную зону в радиусе около двух десятков метров.\
        ...
        <Flex.Item width="33%" shrink={1}>
          ...
          >
            <Button
              className={
                !blocked_TGUI_rows[0] ? rowStyles[0].red : rowStyles[0].disabled
              }
              height="64px"
              width="100%"
              disabled={blocked_TGUI_rows[0]}
            ...
            <Button
              className={
                !blocked_TGUI_rows[1] ? rowStyles[0].red : rowStyles[0].disabled
              }
              height="64px"
              width="100%"
              disabled={blocked_TGUI_rows[1]}
            ...
            >
              ...
              <Tooltip
                ...
                content={
                  "Мгновенно вводит в вас мощную эксперементальную сыворотку ускоряющую вас в бою и помогающую быстрее оклематься от оглушающих эффектов.\
            ...
            <Button
              className={
                !blocked_TGUI_rows[2] ? rowStyles[0].red : rowStyles[0].disabled
              }
              height="64px"
              width="100%"
              disabled={blocked_TGUI_rows[2]}
            ...
            <Button
              className={
                !blocked_TGUI_rows[3] ? rowStyles[0].red : rowStyles[0].disabled
              }
              height="64px"
              width="100%"
              disabled={blocked_TGUI_rows[3]}
            ...
            <Button
              className={
                !blocked_TGUI_rows[4] ? rowStyles[0].red : rowStyles[0].disabled
              }
              height="64px"
              width="100%"
              disabled={blocked_TGUI_rows[4]}
